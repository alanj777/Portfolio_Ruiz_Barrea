        ...
        <div className="bottom_nav_section">
          <div className="bot_nav_left">
            <div className="bot_left_header">
              ...
              >
                <h3>VicenteRB | Portfolio</h3>
              </HashLink>
            </div>
            <div className="bot_middle_info">
              <p className="basic_info">
                Necesitas contactarme porque te bugueé un juego?
                Acá tenés mi contacto: 1111111111
              </p>
              <p className="f_info">Sigueme para ver mas de mis projectos.</p>
            </div>
            <div>
              <Githubcomp
